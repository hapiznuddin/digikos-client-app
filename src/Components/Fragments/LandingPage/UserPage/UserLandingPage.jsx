  ...
  return (
    <LandingPageLayout  classNameFooter={"mt-32 md:mt-40"} onClickHome={() => {navigate("/")}} onClickFacility={() => {navigate("/")}} onClickRoom={() => {navigate("/")}} onClickContact={() => {scrollToRef(contactRef)}}>
      <div className="flex gap-8 mt-8 lg:mt-20 w-full px-8 md:max-w-screen-lg lg:max-w-screen-xl mx-auto ">
        ...
        <button className={`btn btn-ghost w-full normal-case justify-start rounded-full text-sm font-normal lg:text-lg lg:font-medium hover:bg-primary-50 ${location.pathname === "/user/profil" ? "bg-primary-50 text-primary-500 hover:bg-primary-300 hover:text-primary-600 active:text-neutral-25 active:bg-primary-400" : ""}`}>
          <FaRegUserCircle className="text-2xl"/>
          Profil
          </button>
          </Link>
          <div className="divider -my-8"/>
        <button className={`btn btn-ghost w-full normal-case justify-start rounded-full text-sm font-normal lg:text-lg lg:font-medium hover:bg-primary-50 ${location.pathname === "/" ? "bg-primary-50 text-primary-500 hover:bg-primary-300 hover:text-primary-600 active:text-neutral-25 active:bg-primary-400" : ""}`}>
