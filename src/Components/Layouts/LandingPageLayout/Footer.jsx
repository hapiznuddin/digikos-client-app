...
const Footer = () => {
  return (
    <footer className="mt-28 flex flex-col justify-center items-center">
        ...
        <div className=" bg-secondary-500 flex flex-col justify-center items-center -mt-1">
          <div className=" w-full h-full justify-center items-start flex flex-col lg:flex-row py-10 lg:py-20 gap-12 lg:gap-20 px-16 md:px-32 lg:px-28">
            <div className="flex flex-col justify-center items-center lg:items-start gap-4 lg:gap-8 w-full lg:w-1/5">
              <img
                src="/digikos.png"
            ...
            <div className="flex flex-col justify-center gap-4 lg:gap-8 w-full lg:w-1/4 text-neutral-800">
