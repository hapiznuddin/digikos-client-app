    ...
    >
      ...
      <div className=" bg-secondary-500 flex flex-col justify-center items-center w-full -mt-1">
        <div className=" w-full h-full justify-center items-start flex flex-col lg:flex-row py-10 lg:py-20 gap-12 lg:gap-20 px-16 ">
          ...
          >
            <img src="/digikos.png" className="w-48 aspect-auto lg:w-[250px]" />
            <p className="text-lg font-medium text-center lg:text-left">
              Temukan Hunian Kost Modern, Mudah, dan Aman di Digikos!
            </p>
          </div>
          <div
            className="flex flex-col justify-center gap-4 lg:gap-8 w-full lg:w-96 text-neutral-800"
            data-aos="fade-up"
            data-aos-duration="900"
            data-aos-delay="200"
            data-aos-easing="ease-out-quad"
